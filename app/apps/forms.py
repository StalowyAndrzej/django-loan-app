...
class ApprovalForm (forms.Form):
    ...
    Dependents = forms.IntegerField(widget=forms.NumberInput(attrs={'placeholder': 'Number of Dependents'}))
    ApplicantIncome = forms.IntegerField(widget=forms.NumberInput(attrs={'placeholder': 'Monthly Gross Income'}))
    CoapplicantIncome = forms.IntegerField(widget=forms.NumberInput(attrs={'placeholder': 'Co-Applicant Monthly G Income'}))
